...
/// Represents a MiniJinja environment tailored for asset360 bindings.
#[wasm_bindgen]
#[derive(Clone)]
...
impl MiniJinjaEnvironment {
    ...
    /// Enables or disables automatic trailing newline preservation.
    #[wasm_bindgen(getter)]
    ...
    /// Configures undefined behavior policy.
    #[wasm_bindgen(getter)]
