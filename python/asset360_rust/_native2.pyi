...
def blame_map_to_path_stage_map(value:asset360_rust.LinkMLInstance, blame_map:dict[int, dict[str, typing.Any]]) -> list[tuple[list[str], dict[str, typing.Any]]]: ...
...
def get_blame_info(value:LinkMLInstance, blame_map:dict) -> typing.Optional[Asset360ChangeMeta]: ...
