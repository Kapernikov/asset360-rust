...
def blame_map_to_path_stage_map(value:asset360_rust.LinkMLInstance, blame_map:dict[int, dict[str, typing.Any]]) -> list[tuple[list[str], asset360_rust.Asset360ChangeMeta]]: ...
